      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
              Afya<span className="text-teal-500">Smart</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              AI-powered health insights to help you understand your symptoms and make informed decisions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-teal-500 dark:text-gray-300 dark:hover:text-teal-400 transition-colors duration-300">
                  Health Articles
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-gray-500 dark:text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} AfyaSmart. All rights reserved. Not intended for medical advice.
          </p>
        </div>
      </div>
    </footer>
